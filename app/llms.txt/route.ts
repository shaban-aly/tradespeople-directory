...
export async function GET() {
  ...
  const lines = [
    ...
    `> ${siteDescription}`,
    "",
    `> الموقع مخصص للبحث عن صنايعية في مدينة السويس، مصر. يمكن للزوار الاتصال بالصنايعي مباشرة عبر الهاتف أو واتساب.`,
    "",
    "## صفحات أساسية",
    ...
    `- [إضافة صنايعي](${siteUrl}/join): إضافة صنايعي للدليل (يتطلب تسجيل دخول)`,
    "",
    "## التخصصات",
    ...categories.map(
      (category) =>
